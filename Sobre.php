        ...
        <section class="first-section"> 
            <div class="carousel-container">
                <div class="carousel-slide">
                    <img src=".\images\img1-carousel.png" alt="Imagem 1">
                    <img src=".\images\img2-carousel.png" alt="Imagem 2">
                    <img src=".\images\img3-carousel.png" alt="Imagem 3">
                </div>
            </div>
            <div  class="x-bar1">
                <h2 class="text-bar1">Sobre Nós</h2>
