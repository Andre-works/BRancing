...
<body id="Inicio">
    ...
    <main>
        <section class="first-section"> 
            ...
            <div>
                <img class="img-p1" src=".\images\Piloto 1.jpg">
            </div>
            <div class="fe-block fe-block-60d3466afb5869a823e1" style="mix-blend-mode: normal;">
                ...
                <div>
                    <h1 class="nome"><svg fill="#1A9FBA" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                        width="50px" height="50px" viewBox="0 0 391.285 391.285"
                        xml:space="preserve">
                    <g>
                        <g>
                    ...
                    </svg>‎ Bernardo Sousa</h1>
                    <p class="idade"><span class="sqsrte-text-color--accent">37 Anos | Funchal</span></p>
                </div>
            </div>
            
            <div>
                <div class="textp1">
                    <p>Bernardo Sousa iniciou a sua carreira desportiva em 1999 nos karts, tendo não só participado em corridas a nível nacional como também a nível internacional. Em 2005 decide experimentar uma vertente do desporto automóvel com elevado nível de popularidade na sua terra natal, os ralis. </p>
                    <p>Hugo Magalhães, um jovem de 34 anos e co-piloto de Bernardo Sousa, é já uma referência no mundo do desporto motorizado nacional e internacional. Desportista nato, trabalhador incansável, sempre focado no resultado, exigindo sempre o melhor de si.</p>
                </div>
                <div class="conquist">
        ...
        <section class="second-section">
            <div>
                <img class="img-p1" src=".\images\Piloto 2.jpg">
            </div>
            <div class="fe-block fe-block-60d3466afb5869a823e1" style="mix-blend-mode: normal;">
                <div class="sqs-block shape-block sqs-block-shape sqs-stretched preFade fadeIn" data-blend-mode="NORMAL" data-block-type="71" id="block-60d3466afb5869a823e1" style="transition-timing-function: ease; transition-duration: 1.5s; transition-delay: 0.112195s;">
                    <div class="sqs-block-content">
                ...
                <div>
                    ...
                    </svg>‎ Filipe Cameirinha</h1>
                    <p class="idade"><span class="sqsrte-text-color--accent">42 Anos | Beja</span></p>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="conquist">
                    ...
                    <p class="ctext2">Campeão</p>
                </div>
            </div>
        </section>
        <section class="thirt-section">
            <div>
                <img class="img-p1" src=".\images\Piloto 2.jpg">
            </div>
            <div class="fe-block fe-block-60d3466afb5869a823e1" style="mix-blend-mode: normal;">
